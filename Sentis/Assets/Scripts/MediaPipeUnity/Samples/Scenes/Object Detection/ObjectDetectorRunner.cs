...
namespace Mediapipe.Unity.Sample.ObjectDetection
{
  public class ObjectDetectorRunner : VisionTaskApiRunner<ObjectDetector>
  {
    ...
    [SerializeField] private CustomModel customModel;
      ...
      while (true)
      {
        ...
        switch (taskApi.runningMode)
        {
          ...
          case Tasks.Vision.Core.RunningMode.LIVE_STREAM:
            {
              ObjectDetectionResult YOLOresult = customModel.Detect(texture);
              _detectionResultAnnotationController.DrawLater(YOLOresult);
