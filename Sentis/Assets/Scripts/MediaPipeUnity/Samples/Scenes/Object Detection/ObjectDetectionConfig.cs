...
namespace Mediapipe.Unity.Sample.ObjectDetection
{
  ...
  public class ObjectDetectionConfig
  {
    ...
    public ModelType Model { get; set; } =  ModelType.SSDMobileNetV2Float16; //ModelType.EfficientDetLite0Float16; 
    ...
    public string ModelPath
    {
      get
      {
        switch (Model)
        {
          ...
          case ModelType.YOLOv8nFloat32:
            return "yolov8n_float32.bytes";
          default:
            return null;
        }
      }
